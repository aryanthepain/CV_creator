      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            How <span className="gradient-text">HexCode</span> Works
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Three simple steps to go from idea to a deployed portfolio website.
          </p>
        </motion.div>
        ...
        >
          {features.map((f, i) => (
            <motion.div
              key={f.title}
              variants={item}
              className="glass glass-hover p-8 text-center transition-all duration-300 group cursor-default"
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-indigo-500/10 text-indigo-400 mb-6 group-hover:bg-indigo-500/20 transition-colors">
                {f.icon}
              </div>
              <div className="text-xs font-semibold text-indigo-400 mb-2 tracking-widest uppercase">
                Step {i + 1}
              </div>
